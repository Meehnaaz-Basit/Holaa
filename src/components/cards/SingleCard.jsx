const SingleCard = ({ image, name, type }) => {
  return (
    <div className="flex lg:flex-col md:flex-row md:pt-10 items-center lg:-mt-20 ">
      <div>
        <img
          src={image}
          className="lg:w-72 md:w-36 mx-auto object-cover mb-5"
          alt=""
        />
      </div>
      {/* <div></div> */}
      <h3 className="uppercase font-bold lg:text-3xl md:text-xl">{name}</h3>
